Public Class clsStart
    ...
    Shared Sub Main()
        ...
        Try
            ...
            omenu = oApplication.SBO_Application.Menus.Item("Z_mnu_LE002")
            omenu.Image = Application.StartupPath & "\DataBest.bmp"
            oApplication.Utilities.Message("Daily Facts Import Addon Connected successfully", SAPbouiCOM.BoStatusBarMessageType.smt_Success)
