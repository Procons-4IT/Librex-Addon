...
#Region "Private Functions"
    ...
    Private Sub AddFields(ByVal strTab As String, _
        ...
        Try
            ...
            If Not (strTab = "OADM" Or strTab = "OWOR" Or strTab = "OASC" Or strTab = "INV1" Or strTab = "RDR1" Or strTab = "OINV" Or strTab = "ORDR") Then
                strTab = "@" + strTab
            End If
...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        ...
        Try
            ...
            AddTables("Z_ODFACT", "Import Daily facts Details", SAPbobsCOM.BoUTBTableType.bott_NoObject)

            AddFields("Z_ODFACT", "Z_Code", "Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            AddFields("Z_ODFACT", "Z_Date", "Date", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("Z_ODFACT", "Z_Day", "Day", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            AddFields("Z_ODFACT", "Z_Lead", "Leads_D", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_ODFACT", "Z_Dea_G", "Dealers_G", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_ODFACT", "Z_Dea_W", "Dealers_W", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_ODFACT", "Z_DemosD", "Demos_D", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_ODFACT", "Z_AppD", "APP_D", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_ODFACT", "Z_SalesD", "Sales_D", SAPbobsCOM.BoFieldTypes.db_Numeric)


            AddTables("Z_OUCT", "Import Daily facts Details", SAPbobsCOM.BoUTBTableType.bott_NoObject)

            AddFields("Z_OUCT", "Z_Code", "Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            AddFields("Z_OUCT", "Z_Name", "Customer Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            AddFields("Z_OUCT", "Z_LCode", "Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            AddFields("Z_OUCT", "Z_LName", "Customer Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            AddFields("Z_OUCT", "Z_Date", "Date", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("Z_OUCT", "Z_Area", "Area", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_OUCT", "Z_Phone", "Phone", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_OUCT", "Z_CancelP", "Cance Prior Sale", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            AddFields("Z_OUCT", "Z_RitSNO", "Riteller Serial No", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            AddFields("Z_OUCT", "Z_PwrNZSno", "Power NZL Serial No", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            AddFields("Z_OUCT", "Z_ShampSno", "Shampooer Serial No", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
